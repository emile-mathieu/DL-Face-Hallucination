...
conda activate DL2 #change to your own environment

export LD_LIBRARY_PATH="$CONDA_PREFIX/lib:$LD_LIBRARY_PATH"
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

WORKDIR=/home/msds/tans0444 #change this to your own directory 
SCRIPT_NAME=bichannel5.py
IMAGE_ROOT=/home/msds/tans0444/celeba/img_align_celeba #change this to your own directory 
