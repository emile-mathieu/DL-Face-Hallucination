...
Changes vs previous version:
  ...
  5. changed to image mean/sd, changed order to blur then downfactor 
  6. also used pretrained weights from basiccnn if there is any 
'''
...
# Hyperparameters
# Paper: batch=200, lr=1e-5, momentum=0.9, ~5000 cycles, lr divided by 10 on plateau
# Deviations from paper are noted inline.
BATCH_SIZE = 32        # paper: 200 (reduced for memory)
NUM_EPOCHS = 50
LEARNING_RATE = 1e-3   # paper: 1e-5 (increased for faster convergence with smaller batch)
